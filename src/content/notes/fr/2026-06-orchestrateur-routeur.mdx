...
Avant le code, l'essentiel : chacune de ces trois pièces n'est pas un bloc de TypeScript, c'est un **dossier**. Le pattern que je répète depuis [l'article harness](/notes/2026-06-harness-agent-sdk) — `agent.md` + `skill` + `tools` — s'applique tel quel. Voici l'arborescence complète du système :
