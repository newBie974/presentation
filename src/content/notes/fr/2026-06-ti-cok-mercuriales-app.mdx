---
title: "Ti Cok : je transforme des PDF de prix en app anti-vie-chère"
date: 2026-06-19
locale: fr
translationKey: "2026-06-ti-cok-mercuriales"
tags: ["build", "ia", "data"]
excerpt: "Je build une app pour La Réunion : le vrai prix des fruits et légumes existe déjà, public, coincé dans des PDF que personne ne lit. Ti Cok les libère — Sak i lé bon marché, kan, é ousa. Le build, et pourquoi je challenge l'idée avant d'y croire."
draft: false
---
...
<figure>
  <Image src={tiCok} alt="Ti Cok, la mascotte : un boug péi avec chapeau bakoua, son cabas et un panier de fruits et légumes" widths={[240, 320, 480]} sizes="(max-width: 600px) 60vw, 320px" />
  <figcaption>Ti Cok, la mascotte — le boug péi qui connaît les bons prix.</figcaption>
</figure>
...
<Callout tone="info">
La donnée ouverte, c'est rarement un fichier propre qu'on branche. C'est de la matière brute, honnête mais hostile : à crawler, parser, normaliser, historiser avant qu'elle vaille quelque chose pour un humain. **Sur Ti Cok, le pipeline de données n'est pas un détail technique — c'est le produit.**
</Callout>
...
<figure>
  <Image src={tiCokPanier} alt="Ti Cok tenant un panier garni de fruits et légumes péi" widths={[240, 320, 480]} sizes="(max-width: 600px) 60vw, 280px" />
