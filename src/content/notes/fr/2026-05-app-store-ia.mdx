...
### 5. Privacy Policy + Terms accessibles dans l'app

Cliquables depuis Settings **et** depuis le paywall. Utiliser `WebBrowser.openBrowserAsync()` plutôt que `Linking.openURL()` (qui peut crasher sur certains devices).

### 6. Disclaimer santé / bien-être
...
### 7. `NSMicrophoneUsageDescription` en anglais
