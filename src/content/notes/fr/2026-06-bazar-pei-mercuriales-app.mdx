---
title: "Bazar Péi : je transforme des PDF de prix en app anti-vie-chère"
date: 2026-06-19
locale: fr
translationKey: "2026-06-bazar-pei-mercuriales"
tags: ["build", "ia", "data"]
excerpt: "Je build une app pour La Réunion : le vrai prix des fruits et légumes existe déjà, public, coincé dans des PDF que personne ne lit. Bazar Péi les libère — Sak i lé bon marché, kan, é ousa. Le build, et pourquoi je challenge l'idée avant d'y croire."
draft: false
---

import Callout from "@/components/prose/Callout.astro";

Je build **Bazar Péi** : une app mobile pour La Réunion contre la vie chère sur les fruits et légumes. La promesse, en créole : **« Sak i lé bon marché, kan, é ousa »** — ce qui est au bon prix, quand, et où.
...
<Callout tone="info">
La donnée ouverte, c'est rarement un fichier propre qu'on branche. C'est de la matière brute, honnête mais hostile : à crawler, parser, normaliser, historiser avant qu'elle vaille quelque chose pour un humain. **Sur Bazar Péi, le pipeline de données n'est pas un détail technique — c'est le produit.**
</Callout>
...
Bazar Péi répond à trois questions :
...
Donc Bazar Péi n'est pas un comparateur de caddies en direct. C'est un **outil de tendance et de saisonnalité** : il te dit quel produit est structurellement au bon prix en ce moment. Moins sexy, mais vrai — et suffisant pour mieux acheter.
