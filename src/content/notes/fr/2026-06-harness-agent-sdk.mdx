...
<HarnessLayers
  items={["observabilité", "garde-fous", "outils & boucle", "contexte & mémoire"]}
  coreLabel="cœur LLM"
  coreNote="call → observe → decide → repeat"
  ariaLabel="Les couches du harness : le cœur LLM au centre, enveloppé par contexte & mémoire, outils & boucle, garde-fous, puis observabilité."
/>
