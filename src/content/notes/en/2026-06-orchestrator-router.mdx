...
Before the code, the key point: each of these three pieces isn't a block of TypeScript, it's a **folder**. The pattern I've repeated since [the harness article](/notes/2026-06-harness-agent-sdk) — `agent.md` + `skill` + `tools` — applies as-is. Here's the system's full tree:
