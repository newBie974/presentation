---
title: "Ti Boug: turning price PDFs into an anti-cost-of-living app"
date: 2026-06-19
locale: en
translationKey: "2026-06-ti-cok-mercuriales"
tags: ["build", "ia", "data"]
excerpt: "I'm building an app for Réunion: the real price of fruit and veg already exists, public, stuck in PDFs nobody reads. Ti Boug sets it free — what's cheap, where, and when. The build, and why I challenge the idea before believing it."
draft: false
---
...
I'm building **Ti Boug**: a mobile app for Réunion Island fighting the high cost of living on fruit and vegetables. The promise, in Creole: **"Sak lé bon marché, ousa é kansa"** — what's cheap, where, and when.

Ti Boug is also the character: the local *boug* who heads to the market at dawn and never misses a good deal. 🧺
...
<figure>
  ...
  <figcaption>Ti Boug, the mascot — the local lad who knows the good prices.</figcaption>
</figure>
...
<Callout tone="info">
Open data is rarely a clean file you just plug in. It's raw material — honest but hostile: you crawl it, parse it, normalise it, archive it before it means anything to a human. **On Ti Boug, the data pipeline isn't a technical detail — it's the product.**
</Callout>
...
Ti Boug answers three questions:
...
<figure>
  <Image src={tiBougPanier} alt="Ti Boug holding a basket full of local fruit and vegetables" widths={[240, 320, 480]} sizes="(max-width: 600px) 60vw, 280px" />
...
So Ti Boug isn't a live cart comparator. It's a **trend and seasonality tool**: it tells you which product is structurally well-priced right now. Less sexy, but true — and enough to buy better.
