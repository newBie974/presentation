---
title: "Bazar Péi: turning price PDFs into an anti-cost-of-living app"
date: 2026-06-19
locale: en
translationKey: "2026-06-bazar-pei-mercuriales"
tags: ["build", "ia", "data"]
excerpt: "I'm building an app for Réunion: the real price of fruit and veg already exists, public, stuck in PDFs nobody reads. Bazar Péi sets it free — what's cheap, when, and where. The build, and why I challenge the idea before believing it."
draft: false
---

import Callout from "@/components/prose/Callout.astro";

I'm building **Bazar Péi**: a mobile app for Réunion Island fighting the high cost of living on fruit and vegetables. The promise, in Creole: **"Sak i lé bon marché, kan, é ousa"** — what's cheap, when, and where.
...
<Callout tone="info">
Open data is rarely a clean file you just plug in. It's raw material — honest but hostile: you crawl it, parse it, normalise it, archive it before it means anything to a human. **On Bazar Péi, the data pipeline isn't a technical detail — it's the product.**
</Callout>
...
Bazar Péi answers three questions:
...
So Bazar Péi isn't a live cart comparator. It's a **trend and seasonality tool**: it tells you which product is structurally well-priced right now. Less sexy, but true — and enough to buy better.
